...
exports.generateGoalsAndTasks = void 0;
const index_1 = require("../../index");
const family_model_1 = require("../../models/family.model");
const user_model_1 = require("../../models/user.model");
const generateGoalsAndTasks = (userId, lastChats, completedTasks, interests) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const goal = {
        ...
        tasks: generatedGoal.tasks.map((task) => ({
            title: task.title,
    ...
    yield user.save(); // Save user with the new goal if personal
    return goal;
});
exports.generateGoalsAndTasks = generateGoalsAndTasks;
